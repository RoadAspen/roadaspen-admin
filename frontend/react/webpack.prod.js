...
const { CleanWebpackPlugin } = require('clean-webpack-plugin'); // build时清空目标文件夹
...
module.exports = {
    ...
    optimization: {
        ...
        //     chunks: 'all', //推荐为all。 async 是将按需加载的块分割出来。 initial 是 初始块，即在所有逻辑代码之前需要导入的依赖代码，又叫入口代码，如 react ，react-router。
